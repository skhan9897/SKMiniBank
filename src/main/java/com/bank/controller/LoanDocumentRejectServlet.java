...
@WebServlet("/LoanDocumentRejectServlet")
public class LoanDocumentRejectServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request,
        ...
        try {
            ...
            boolean status =
                    dao.rejectDocuments(loanId, verifiedBy);
