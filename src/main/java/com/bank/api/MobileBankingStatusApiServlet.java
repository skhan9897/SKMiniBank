...
@WebServlet("/api/mobilebanking/status")
public class MobileBankingStatusApiServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request,
        ...
        try {
            ...
            ServiceRequest service = dao.getLatestRequestByType(customerId, "MOBILE_BANKING");

            if (service == null) {
                response.getWriter().print("{\"success\":false,\"message\":\"No Mobile Banking request found\"}");
                return;
            }
