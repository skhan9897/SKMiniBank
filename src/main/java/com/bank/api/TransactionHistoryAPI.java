...
@WebServlet("/api/transactionHistory")
public class TransactionHistoryAPI extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request,
        ...
        try {
            ...
            json.append("\"count\":").append(list.size()).append(",");
            ...
            for (int i = 0; i < list.size(); i++) {
                ...
                json.append("\"transactionType\":\"")
                        .append(t.getTransactionType())
                        .append("\",");
