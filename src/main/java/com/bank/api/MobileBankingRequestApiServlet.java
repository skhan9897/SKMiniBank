...
public class MobileBankingRequestApiServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean success = service.submitMobileBankingRequest(customerId, accountNumber);

            if (success) {
                response.getWriter().print("{\"status\":\"success\",\"message\":\"Mobile Banking Request Submitted\"}");
            } else {
